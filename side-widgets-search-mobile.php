<?php
/**
 * Symnel Side Widgets for Search (Mobile)
 *
 * @package Osclass
 * @subpackage Symnel
 * @since Symnel 1.0
...
<div class="alert-block visible-portrait-block col-md-10">
                    ...
                    <div class="form-group clearfix">
                        <div class="price-slice">
                            ...
                            <div class="input-group input-group-sm">
                              ...
                              <input class="input-sm form-control" type="text" id="priceMin" name="sPriceMin" value="<?php echo osc_esc_html( osc_search_price_min() ); ?>" maxlength="8" />
                            </div>
                            <div class="input-group input-group-sm">
                              <span class="input-group-addon"><?php _e( 'Max', 'symnel' ) ; ?></span>
                              <input class="input-sm form-control" type="text" id="priceMax" name="sPriceMax" value="<?php echo osc_esc_html( osc_search_price_max() ); ?>" maxlength="8" />
                            </div>
                        </div>
                    </div>
                    <?php } ?>
