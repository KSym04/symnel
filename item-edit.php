<?php
/**
 * Symnel Item Edit Page - File that renders edit of posted listing.
 *
 * @package Osclass
 * @subpackage Symnel
 * @since Symnel 1.0
...
function custom_meta_title( $data ) {
  return __( sprintf( 'Edit Ads / %s', osc_page_title() ), 'symnel' );
}
...
osc_current_web_theme_path( 'framework/backend/header-backend.php' ); ?>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="dopebackend-title col-lg-12">
            <h1><?php _e( 'Edit Ads', 'symnel' ); ?><a href="<?php echo osc_item_post_url_in_category(); ?>" class="btn btn-info btn-xs"><?php _e( 'Add New Ads', 'symnel' ); ?></a></h1>
