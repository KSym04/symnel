 ...
 */
?>
    <?php osc_run_hook( 'before-side-widgets' ); ?>

    <div class="widgets-block col-md-3">
      <?php osc_run_hook( 'before-inner-side-widgets' ); ?>
        ...
        <?php } ?>
      <?php osc_run_hook( 'after-inner-side-widgets' ); ?>
    </div>

    <?php osc_run_hook( 'after-side-widgets' ); ?>
